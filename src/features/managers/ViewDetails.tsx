            ...
            {projects.length === 0 ? (
              ...
              <div className="mt-6 space-y-4">
                {projects.map((project) => (
                  ...
                  >
                    <summary className="flex cursor-pointer items-center justify-between gap-4 bg-white px-5 py-4 text-sm font-medium text-slate-900 transition hover:bg-slate-100">
                      <div>
                    ...
                    <div className="border-t border-slate-200 bg-slate-50 px-5 py-5 text-sm text-slate-600">
